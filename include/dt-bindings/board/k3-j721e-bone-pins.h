...
#define P9_24A(mode, mux) J721E_IOPAD(0x034, mode, mux)       /* Y5 */
#define P9_24B(mode, mux) J721E_IOPAD(0x1E0, mode, mux)       /* AJ24 */
#define P9_25A(mode, mux) J721E_IOPAD(0x200, mode, mux)       /* AC4 */
#define P9_25B(mode, mux) J721E_IOPAD(0x1A4, mode, mux)       /* W26 */
#define P9_26A(mode, mux) J721E_IOPAD(0x030, mode, mux)       /* Y1 */
#define P9_26B(mode, mux) J721E_IOPAD(0x1DC, mode, mux)       /* AF24 */
...
#define P9_29A(mode, mux) J721E_IOPAD(0x0D8, mode, mux)       /* V5 */
#define P9_29B(mode, mux) J721E_IOPAD(0x23C, mode, mux)       /* AB25 */
#define P9_30A(mode, mux) J721E_IOPAD(0x0B4, mode, mux)       /* V6 */
#define P9_30B(mode, mux) J721E_IOPAD(0x238, mode, mux)       /* AE28 */
#define P9_31A(mode, mux) J721E_IOPAD(0x0D4, mode, mux)       /* U3 */
#define P9_31B(mode, mux) J721E_IOPAD(0x234, mode, mux)       /* AB26 */
