...
#define P8_38A(mode, mux) J721E_IOPAD(0x1A8, mode, mux)       /* Y29 */
#define P8_38B(mode, mux) J721E_IOPAD(0x024, mode, mux)       /* AJ20 */
...
#define P9_24A(mode, mux) J721E_IOPAD(0x034, mode, mux)       /* AJ24 */
#define P9_24B(mode, mux) J721E_IOPAD(0x1E0, mode, mux)       /* Y5  */
#define P9_25A(mode, mux) J721E_IOPAD(0x200, mode, mux)       /* AC4 */
#define P9_25B(mode, mux) J721E_IOPAD(0x1A4, mode, mux)       /* W26 */
#define P9_26A(mode, mux) J721E_IOPAD(0x030, mode, mux)       /* AF24 */
#define P9_26B(mode, mux) J721E_IOPAD(0x1DC, mode, mux)       /* Y1 */
...
#define P9_29A(mode, mux) J721E_IOPAD(0x0D8, mode, mux)       /* AB25 */
#define P9_29B(mode, mux) J721E_IOPAD(0x23C, mode, mux)       /* V5 */
#define P9_30A(mode, mux) J721E_IOPAD(0x0B4, mode, mux)       /* AE28 */
#define P9_30B(mode, mux) J721E_IOPAD(0x238, mode, mux)       /* V6 */
#define P9_31A(mode, mux) J721E_IOPAD(0x0D4, mode, mux)       /* AB26 */
#define P9_31B(mode, mux) J721E_IOPAD(0x234, mode, mux)       /* U3 */
#define P9_33A(mode, mux) J721E_IOPAD(0x0CC, mode, mux)       /* AC28 */
#define P9_33B(mode, mux) J721E_WKUP_IOPAD(0x140, mode, mux)  /* K24 */
#define P9_35A(mode, mux) J721E_IOPAD(0x0E0, mode, mux)       /* AH27 */
#define P9_35B(mode, mux) J721E_WKUP_IOPAD(0x148, mode, mux)  /* K29 */
#define P9_36A(mode, mux) J721E_IOPAD(0x0E4, mode, mux)       /* AH29 */
#define P9_36B(mode, mux) J721E_WKUP_IOPAD(0x144, mode, mux)  /* K27 */
#define P9_37A(mode, mux) J721E_IOPAD(0x0E8, mode, mux)       /* AG28 */
#define P9_37B(mode, mux) J721E_WKUP_IOPAD(0x138, mode, mux)  /* K28 */
#define P9_38A(mode, mux) J721E_IOPAD(0x0EC, mode, mux)       /* AG27 */
#define P9_38B(mode, mux) J721E_WKUP_IOPAD(0x13C, mode, mux)  /* L28 */
#define P9_39A(mode, mux) J721E_WKUP_IOPAD(0x130, mode, mux)  /* K25 */
#define P9_39B(mode, mux) J721E_IOPAD(0x0DC, mode, mux)       /* AJ28 */
#define P9_40A(mode, mux) J721E_IOPAD(0x148, mode, mux)       /* AA26 */
#define P9_40B(mode, mux) J721E_WKUP_IOPAD(0x134, mode, mux)  /* K26 */
